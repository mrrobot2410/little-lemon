  ...
  return (
    <>
      ...
      <form style={{ display: 'grid', maxWidth: '200px', gap: '20px' }} onSubmit={handleSubmit}>
        ...
        <input type="date" id="res-date" value={data.date} onChange={handleInputChange} name='date'/>
        <label htmlFor="res-time">Choose time</label>
        <select id="res-time" value={data.time} onChange={handleTimeChange} name='time'>
